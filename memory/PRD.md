...
## Architecture
- **Frontend**: React + Tailwind CSS + Shadcn UI + Recharts + Leaflet (port 3000)
...
- **Maps**: Leaflet + react-leaflet with CartoDB Dark Matter tiles, OpenStreetMap Nominatim geocoding

## What's Been Implemented
- Pixel-perfect landing page with 12-feature showcase
...
- Interactive sighting map: full-page dark-themed map with color-coded markers, auto-fit bounds, stats overlay, legend
